...
function credentialsToEnv(provider, creds) {
  ...
  switch (provider) {
    ...
    case "github":
      ...
      break
    case "supabase":
      if (creds.access_token) env.SUPABASE_ACCESS_TOKEN = creds.access_token
      if (creds.refresh_token) env.SUPABASE_REFRESH_TOKEN = creds.refresh_token
      break
    case "zillow":
    ...
    case "gcp":
      ...
      break
    case "gcp-console":
      if (creds.all_cookies) env.GCP_CONSOLE_ALL_COOKIES = creds.all_cookies
