...
const STATUS_MESSAGES: Record<SessionStatus, string> = {
  ...
  ready: "Browser ready — log in to X",
...
export function XBrowser({ wsUrl, token, onComplete, onCancel }: XBrowserProps) {
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col gap-3">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button variant="outline" size="sm" onClick={handleCancelClick} disabled={isDone}>
          Cancel
        </Button>
      </div>
    </div>
